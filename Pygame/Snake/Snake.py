...
def move(): 
    ...
    if keys[pygame.K_LEFT] and noLeft == False:
        turnLeft = True
        
    if keys[pygame.K_RIGHT] and noRight == False:
        turnRight = True
         
    if keys[pygame.K_UP] and noUp == False:
        turnUp = True
        
    if keys[pygame.K_DOWN] and noDown == False:
        turnDown = True       
