...
class textAnalysis:
    ...
    def motifNaive(self, motif):
        if len(motif) > len(self.text):
            return(False, None)
        for i in range(len(self.text) - len(motif)):
            if self.text[i:i+len(motif)] == motif:
                return(True, i)
        return(False, None)
    
    def motifMoinsNaive(self, motif):
        if len(motif) > len(self.text):
            return(False, None)
        for i in range(len(self.text) - len(motif)):
            if self.text[i:i+len(motif)] == motif:
...
if __name__ == '__main__':
    ...
    print(myText.motifNaive("small"))
    print(palindrome("eluparcettecrapule"))
    print(palindrome("eluparcettecraule"))
    print(palindromeIte("eluparcettecrapule"))
    print(palindromeIte("eluparcettecraule"))